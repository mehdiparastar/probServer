export enum commands {
    ...
    getMCIFTPFile1 = 'AT+QFTPGET="./Upload/QuectelMSDocs.zip","UFS:QuectelMSDocs.zip"\r\n',
    getMCIFTPFile = 'AT+QFTPGET="../amir/downloads/Autodesk.Maya.2020.4.x64.rar?1612964196","UFS:QuectelMSDocs.zip"\r\n',
